...
import logo from "../assets/images/arrow-go-back.png";
	...
	return (
		<div className="window-auth">
			<div className="window-auth__container">
				<h1>
					<Link to="/">
						<img className="arrow-back" width={20} height={20} src={logo} alt="back" />
					</Link>
					Войти
				</h1>
				<div className="window-auth__email">
					{emailSelect && emailError ? (
						emailSelect &&
						emailError && (
							<label htmlFor="input_email" style={{ color: "rgb(255, 97, 58)" }}>
								{emailError}
							</label>
						)
					) : (
				...
				<div className="window-auth__pass">
					{passwordSelect && passwordError ? (
						passwordSelect &&
						passwordError && (
							<label htmlFor="input_password" style={{ color: "rgb(255, 97, 58)" }}>
								{passwordError}
							</label>
						)
					) : (
				...
				<button style={{ marginTop: "17px" }} className="grey_button window-auth__grey_button">
					Вход
				</button>
