...
function FormRegistration() {
    ...
    const errorEmail = document.querySelector('.registration-card__incorrect-input');
    ...
    if (email.length === 0) {
        ...
        hideErrorName(errorEmail);
    }

    if (!validateEmail(email) && email.length >= 1) {
        showErrorName(errorEmail);
        errorBorder(inputEmail);
		...
		<div className="registration-card">
			...
			<form action="#" className="registration-card__form-registration">
				...
				<div className="registration-card__foto">
					<span className="foto__span">Ваше фото</span>
